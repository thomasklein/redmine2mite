...
Click on the orange timer right beside the Redmine2mite preferences link. It links to the list of time entries of the associated issue. Beside the active time entry is a rotating clock. Click on it to stop the time tracker and save the current time both to Redmine and to mite.
